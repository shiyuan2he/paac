...
bb.num=$("<input disabled=\"disabled\" class=\"pagination-num\" type=\"text\" value=\"1\" size=\"1\">").appendTo(tr).wrap("<td></td>");
...
if(bb.num){
$(".pagination-num").css("width",7*(String(_b3.pageNumber).length));
...
cc.push("<span custom_tree_id=\""+item.id+"\" style=\"display:none;\">"+item.id+"</span>");
cc.push("</div>");
if(item.children&&item.children.length){
...
$.fn.panel.defaults={id:null,title:null,iconCls:null,width:"auto",height:"auto",left:null,top:null,cls:null,headerCls:null,bodyCls:null,style:{},href:null,cache:true,fit:false,border:true,doSize:true,noheader:false,content:null,collapsible:false,minimizable:false,maximizable:false,closable:false,collapsed:false,minimized:false,maximized:false,closed:false,tools:null,queryParams:{},method:"get",href:null,loadingMessage:"正在请求加载页面...请稍候。",loader:function(_251,_252,_253){
...
}else if(col.sortable == true){//自定义排序图标用  add by lbj(需要添加特定样式参考：eaInfoAnalysis.jsp)
...
try
{
var row=opts.finder.getRow(_5ba,_5c4);
opts.onMouseOverRow.call(_5ba,e,_5c4,row);
}
catch(err){}
}).bind("mouseout",function(e){
var tr=$(e.target).closest("tr.datagrid-row");
...
//var row=opts.finder.getRow(_5ba,_5c6);
//opts.onMouseOutRow.call(_5ba,e,_5c6,row);
}).bind("click",function(e){
var tt=$(e.target);
