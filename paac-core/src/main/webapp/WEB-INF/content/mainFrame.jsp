...
<html>
	...
	<body class="easyui-layout">
		<!-- 头部 -->
		<div id="mainFrameTop" data-options="region:'north',border:false,href:'<%=path%>/mainFrame/manage/manage_to_mainFrame_top.action'"></div>
		<!-- 中部 -->
		<div id="mainFrameCenter" data-options="region:'center',border:false,href:'' " style="height:100%;width:100%"></div>
		<!-- 底部 -->
		<div id="mainFrameBottom" data-options="region:'south',split:true" 
