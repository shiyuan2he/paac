...
/**
 * @description <p>降级实现TUrmsRoleService接口</p>
 * @author heshiyuan
 * @date 2017/09/05
 ...
 */
public class TUrmsRoleServiceMock extends BaseServiceMock<TUrmsRoleMapper, TUrmsRole, TUrmsRoleExample> implements TUrmsRoleService {
