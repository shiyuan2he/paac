...
/**
 * @description <p>降级实现TUrmsUserService接口</p>
 * @author heshiyuan
 * @date 2017/09/04
 ...
 */
public class TUrmsUserServiceMock extends BaseServiceMock<TUrmsUserMapper, TUrmsUser, TUrmsUserExample> implements TUrmsUserService {
