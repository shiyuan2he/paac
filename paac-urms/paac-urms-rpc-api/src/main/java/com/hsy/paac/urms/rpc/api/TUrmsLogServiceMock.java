...
/**
 * @description <p>降级实现TUrmsLogService接口</p>
 * @author heshiyuan
 * @date 2017/09/05
 ...
 */
public class TUrmsLogServiceMock extends BaseServiceMock<TUrmsLogMapper, TUrmsLog, TUrmsLogExample> implements TUrmsLogService {
