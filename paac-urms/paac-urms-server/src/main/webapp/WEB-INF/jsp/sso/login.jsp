...
<head>
    ...
    <link href="<%=basePath%>/resources/paac-admin/plugins/material-design-iconic-font-2.2.0/css/material-design-iconic-font.min.css"
          rel="stylesheet"/>
    <link href="<%=basePath%>/resources/paac-admin/plugins/waves-0.7.5/waves.min.css" rel="stylesheet"/>
    <link href="<%=basePath%>/resources/paac-admin/plugins/waves-0.7.5/waves.min.css" rel="stylesheet"/>
    <link href="<%=basePath%>/resources/paac-admin/plugins/checkbix/css/checkbix.min.css" rel="stylesheet"/>
    <link href="<%=basePath%>/resources/paac-admin/css/login.css" rel="stylesheet"/>
</head>
<body>
<div id="login-window">
...
<script src="<%=basePath%>/resources/paac-admin/plugins/checkbix/js/checkbix.min.js"></script>
<script>var BASE_PATH = '<%=basePath%>';</script>
<script src="<%=basePath%>/resources/paac-admin/js/login.js"></script>
<script>
