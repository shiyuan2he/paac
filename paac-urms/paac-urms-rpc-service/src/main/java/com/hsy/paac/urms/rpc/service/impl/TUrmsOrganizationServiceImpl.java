...
@Transactional
@BaseService
public class TUrmsOrganizationServiceImpl extends BaseServiceImpl<TUrmsOrganizationMapper, TUrmsOrganization, TUrmsOrganizationExample> implements TUrmsOrganizationService {

    private static Logger _logger = LoggerFactory.getLogger(TUrmsOrganizationServiceImpl.class);

    @Autowired
    TUrmsOrganizationMapper tUrmsOrganizationMapper;
